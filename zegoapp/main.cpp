...
//    QString appId = "4133572644";
    ...
    ZEGO::LIVEROOM::LJLivePublisherCallback *m_pAVSignal = new ZEGO::LIVEROOM::LJLivePublisherCallback;
...
//    LIVEROOM::SetDeviceStateCallback(m_pAVSignal);
    ...
    //初始化SDK
    bool ret = LIVEROOM::InitSDK(g_dwAppID2, (unsigned char*)appSign.toLocal8Bit().data(), 32);
    qDebug()<<ret;
