...
#define ZW_LOG_DEBUG_V(X) ZW_LOG(ZW_LOG_P(X),LOG_LEVEL_DEBUG)
#define ZW_LOG_CRITICAL_V(X) ZW_LOG(ZW_LOG_P(X),LOG_LEVEL_CRITICAL)
#define ZW_LOG_FATAL_V(X) ZW_LOG(ZW_LOG_P(X),LOG_LEVEL_FATAL)
#define ZW_LOG_INFO_V(X) ZW_LOG(ZW_LOG_P(X),LOG_LEVEL_INFO)
#define ZW_LOG_WARNING_V(X) ZW_LOG(ZW_LOG_P(X),LOG_LEVEL_WARNING)
