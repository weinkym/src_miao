...
Shader::Shader(const QString &vsFilenName, const QString &fsFilenName)
{
...
//    m_shaders[1] = CreateShader(LoaderShader("/Users/miaozw/Documents/basicShader.fs"),GL_FRAGMENT_SHADER);
    m_shaders[0] = CreateShader(LoaderShader(vsFilenName),GL_VERTEX_SHADER);
    m_shaders[1] = CreateShader(LoaderShader(fsFilenName),GL_FRAGMENT_SHADER);
